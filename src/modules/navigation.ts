...
export const COMMAND_HELP: CommandHelpLine[] = [
  ...
  { id: '55', label: 'lss: 55reset-related-to-property-order', description: 'Reset and restore related-to when an existing graph needs an explicit native property repair.' },
...
export async function createHelpPage(r: Result): Promise<void> {
  ...
  const body = [
    ...
    '- Commands 53-57 are explicit maintenance and repair commands; short aliases for them are intentionally not registered.',
