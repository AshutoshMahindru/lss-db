...
export const COMMAND_HELP: CommandHelpLine[] = [
  ...
  { id: '38', label: 'lss: 38normalize-properties', description: 'Normalize property aliases on the current page and repair.' },
  { id: '39', label: 'lss: 39convert-text-relationships', description: 'Convert simple text relationship values into page refs on current page and repair.' },
  { id: '40', label: 'lss: 40migrate-namespaced-objects', description: 'Conservatively migrate a namespaced object page to clean page + tag pattern.' },
